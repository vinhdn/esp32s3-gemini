...
extern const lv_image_dsc_t map_tile_nav; /* 159x108 RGB565 - nav-mode inset */
...
#define HUD_MAP_NAV_H      108
#define HUD_MAP_NAV_POS_X  76
#define HUD_MAP_NAV_POS_Y  78   /* tile cropped 28px off the top -> 106-28 */
